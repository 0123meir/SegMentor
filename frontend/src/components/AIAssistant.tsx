...
export const AIAssistant = () => {
  ...
  return (
    <div
      dir="ltr"
      className="bg-white rounded-lg shadow-sm border border-gray-200 my-4 h-[calc(50vh-4rem)] flex flex-col"
    >
      ...
      {error ? (
        <div
          dir="ltr"
          className="bg-white rounded-lg shadow-sm border border-gray-200 my-4 p-4 h-[calc(50vh-4rem)]"
        >
